                    ...
                    <?php foreach($fornecedores as $fornecedor) : ?>
                        ...
                        <?php 
                            ...
                            <td class="changes">
                                ...
                                <a href="#" data-bs-toggle="modal" data-bs-target="#delete-modal" class="btn btn-transparent" data-fornecedor="<?php echo $fornecedor['id_fornecedor']; ?>"><i class="fa-solid fa-trash"></i>&nbsp; Excluir</a>
                            </td>
                        </tr>
                    <?php endforeach ; ?>
                    <?php else : ?>
